...
# Patch upstream portfile.cmake to add emscripten args for threads mode
file(READ "${VCPKG_ROOT_DIR}/ports/icu/portfile.cmake" upstream_content)
if(VCPKG_TARGET_IS_EMSCRIPTEN)
    string(REPLACE "vcpkg_list(SET CONFIGURE_OPTIONS)" "vcpkg_list(SET CONFIGURE_OPTIONS)\nvcpkg_list(APPEND CONFIGURE_OPTIONS \"--with-pic\" \"CFLAGS=-matomics -mbulk-memory\" \"CXXFLAGS=-matomics -mbulk-memory\")" upstream_content "${upstream_content}")
endif()
